...
gcc src/main.c -o bin/maelstrom bin/obj/sph.o bin/obj/kernels.o bin/obj/integrators.o bin/obj/simulation.o bin/obj/storage.o bin/obj/memory.o -lm $(pkg-config --cflags --libs cairo) -std=c2x
